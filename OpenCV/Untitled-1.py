...
FOCAL_LENGTH = 800
ESP_URL = "http://172.20.10.5"   # exemplo:
...
cap = cv2.VideoCapture("http://172.20.10.5")
...
while True:
    ...
    for (x, y, fw, fh) in faces:
        ...
        try:
            payload = {"x": dx, "y": dy, "z": distance}
            requests.get(ESP_URL, params=payload, timeout=0.05)
        except:
            pass  # não trava se o ESP estiver offline # só usa a primeira face
        break  
